...
Rust like many languages today makes use of generics or more formally called
(parametric polymorphism). Generics allow a user to define a "stand-in
          ...
          <div
            dangerouslySetInnerHTML={{
              __html: `<script src="https://utteranc.es/client.js"
                    repo="martinomburajr/blogg"
                    issue-term="pages/rust/index.en-US.mdx"
                    label="comments"
                    theme="github-light"
